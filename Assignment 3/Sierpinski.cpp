...
void drawSierpinskiTriangle(GWindow& window,
    ...
    if (order == 0) {
        ...
        order--;
        drawSierpinskiTriangle(window, x0, y0, (x0 + x1) / 2, (y0 + y1) / 2, (x0 + x2) / 2, (y0 + y2) / 2, order);
        drawSierpinskiTriangle(window, (x0 + x1) / 2, (y0 + y1) / 2, x1, y1, (x1 + x2) / 2, (y1 + y2) / 2, order);
        drawSierpinskiTriangle(window, (x1 + x2) / 2, (y1 + y2) / 2, x2, y2, (x0 + x2) / 2, (y0 + y2) / 2, order);
    }
}
